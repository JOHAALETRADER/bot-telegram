    ...
    if q.data == "registrarme":
        ...
        await q.message.reply_text(MENSAJE_YA_TENGO_CUENTA)
            ...
            await q.message.reply_text(
                ...
                "👉 Instagram: https://instagram.com/johannatrading\n"
                "👉 TikTok: https://tiktok.com/@johannatrading\n"
                "👉 Canal de YouTube: https://youtube.com/@johannatrading\n"
                "👉 Canal de Telegram: https://t.me/johannatrading"
            )
