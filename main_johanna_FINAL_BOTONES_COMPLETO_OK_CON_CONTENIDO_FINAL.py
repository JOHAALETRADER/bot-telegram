...
Recuerda que la cantidad de beneficios varia según tu inversión personal.""")
        ...
        with open("IMG_20250626_172306_849.jpg", "rb") as f1, open("IMG_20250626_172303_416.jpg", "rb") as f2:
            await q.message.reply_photo(f1)
            await q.message.reply_photo(f2)

    elif q.data == "redes_sociales":
        await q.message.reply_text("""🌐 Mis redes sociales:
📺 YouTube: https://youtube.com/@johaalegria.trader?si=JemqmPes0Rz3WqEZ
...
💬 Canal Telegram: https://t.me/JohaaleTraderTeams""")
import logging
import asyncio
