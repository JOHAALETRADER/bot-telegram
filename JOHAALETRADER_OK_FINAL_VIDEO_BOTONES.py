...
Recuerda que la cantidad de beneficios varía según tu inversión personal.""",
        ...
        await context.bot.send_photo(chat_id=chat_id, photo=open("IMG_20250626_172306_849.jpg", "rb"))
        await context.bot.send_photo(chat_id=chat_id, photo=open("IMG_20250626_172303_416.jpg", "rb"))
